...
function Contact() {
    return (
        ...
        <section className="relative overflow-hidden h-[100%] md:h-[95vh] font-poppins">
            <div className="absolute bottom-0 left-0 hidden w-full h-full lg:block lg:w-4/12">
                <img
                    className="object-cover w-full h-full"
                    src="/2004.i603.001_online_education_set-11.jpg"
                    alt=""
                />
            </div>
                ...
                <div className="max-w-5xl mx-auto">
                    <div className="flex flex-col-reverse py-20 -mx-4 lg:flex-row 2xl:py-40">
                        <div className="w-full px-4 lg:w-3/5">
                            <div className="w-full px-8 py-8 bg-white border rounded-md shadow-md lg:ml-20 lg:max-w-md">
                                <form action="">
                                    <div className="mb-6">
                        ...
                        <div className="w-full px-4 mb-8 lg:w-2/5 lg:mb-0">
                            ...
                            <h2 className="mt-6 mb-8 text-4xl font-bold md:mb-10 ">
                                Lets get connected
                            </h2>
                            <div className="flex items-center mb-6">
                                <span className="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg ">
                                    <svg
                                        ...
                                        height={16}
                                        fill="currentColor"
                                        className="w-5 h-5 text-blue-600  bi bi-telephone"
                                        viewBox="0 0 16 16"
                                    >
                            ...
                            <div className="flex items-center mb-6">
                                <span className="flex items-center justify-center w-12 h-12 mr-4 bg-blue-100 rounded-lg  ">
                                    <svg
                                        ...
                                        height={16}
                                        fill="currentColor"
                                        className="w-5 h-5 text-blue-600  bi bi-envelope"
                                        viewBox="0 0 16 16"
                                    >
                            ...
                            <div className="flex items-center mb-6">
                                <span className="flex items-center justify-center flex-shrink-0 w-12 h-12 mr-4 bg-blue-100 rounded-lg ">
                                    <svg
                                        ...
                                        height={16}
                                        fill="currentColor"
                                        className="w-5 h-5 text-blue-600  bi bi-geo-alt"
                                        viewBox="0 0 16 16"
                                    >

...
function Page() {
    ...
    return (
        <section className="flex items-center bg-stone-200 lg:h-screen font-poppins ">
                ...
                <div className="p-8 bg-gray-50 ">
                    ...
                    <div className="flex flex-wrap -mx-4">
                        <div className="w-full px-4 mb-8 xl:w-8/12 xl:mb-0">
                            ...
                            <div className="py-4 mb-8 border-t border-b border-gray-200 overflow-auto overflow-x-hidden h-[400px]">
                                {cart.length > 0 ? cart.map((item: any) => (
                                    <div key={item.id} className="flex flex-wrap justify-between items-center mb-6 -mx-4 md:mb-8">
                                        ...
                                        <div className="hidden px-4  lg:block lg:w-2/12">
                                            <p className="text-lg flex items-center justify-evenly font-bold text-red-500 ">
                        ...
                        <div className="w-full px-4 xl:w-4/12">
                            <div className="p-6 border border-red-100  bg-red-50 md:p-8">
